ARG BASE_IMAGE=ghcr.io/loong64/openjdk-loongson:25-jre-debian-trixie
FROM ${BASE_IMAGE}
...
ADD ${GITHUB_BASEURL}/loong64-abi2-0/easy-add/releases/download/${EASY_ADD_VERSION}/easy-add_${TARGETOS}_${TARGETARCH}${TARGETVARIANT} /usr/bin/easy-add
RUN chmod +x /usr/bin/easy-add

# renovate: datasource=github-releases packageName=loong64-abi2-0/restify
...
# renovate: datasource=github-releases packageName=loong64-abi2-0/rcon-cli
...
# renovate: datasource=github-releases packageName=loong64-abi2-0/mc-server-runner
